...
from micronet_quant import *

saved_model_dir = './'

float_model_file = 'micronet_pretrained_float.pth'
scripted_float_model_file = 'micronet_quantization_scripted.pth'
scripted_quantized_model_file = 'micronet_quantization_scripted_quantized.pth'
scripted_quantized_per_channel_model_file = 'micronet_quantization_scripted_quantized_per_channel.pth'
scripted_quantized_qat_model_file = 'micronet_quantization_scripted_quantized_qat.pth'
...
init_model = MicroNet(ver='ver1',num_classes=41)
torch.save(init_model.state_dict(), saved_model_dir + float_model_file)

def load_model(model_file):
    model = MicroNet(ver='ver1',num_classes=41)
